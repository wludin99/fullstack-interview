...
interface CreateChecklistDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onCreateChecklist: (name: string, description: string, questions: string[], conditions: string[]) => void;
}
...
export const CreateChecklistDialog: React.FC<CreateChecklistDialogProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (name.trim() && validQuestions.length > 0) {
      onCreateChecklist(name.trim(), description.trim(), validQuestions, validConditions);
      handleClose();
    }
  };
